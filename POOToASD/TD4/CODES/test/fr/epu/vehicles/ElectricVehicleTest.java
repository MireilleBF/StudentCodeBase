...
class ElectricVehicleTest {
    ...
    @BeforeEach
    void setUp() {
        electricVehicle = new ElectricVehicle(batteryCapacity, energyConsumptionPerKilometer);
    }
    ...
    void testCalculateMaxRange() {
        assertEquals(batteryCapacity/energyConsumptionPerKilometer, electricVehicle.calculateMaxRange());
    }

    @org.junit.jupiter.api.Test
    void testCalculateMaxDistance() {
        assertEquals(0, electricVehicle.getCurrentCharge());
        assertEquals(electricVehicle.getCurrentCharge()/energyConsumptionPerKilometer, electricVehicle.calculateMaxDistance());
        electricVehicle.charge(10);
        assertEquals(10/energyConsumptionPerKilometer, electricVehicle.calculateMaxDistance());
    }
    @Test
    void testDrive() {
