...
import fr.epu.rentals.NoSuchItemException;
...
class VehiculeRentalSystemTest {
    ...
    @org.junit.jupiter.api.Test
    void testIsRentable() throws NoSuchItemException {
        initRentalSystem();
    ...
    @org.junit.jupiter.api.Test
    void testRentItem() throws NoSuchItemException {
        initRentalSystem();
        vehiculeRentalSystem.rentItem(carBM, today, tomorrow);
    ...
    @org.junit.jupiter.api.Test
    void testRentItemNotRegistered() throws NoSuchItemException {
        initRentalSystem();
        ElectricBike bike = new ElectricBike(30, new double[]{0.2, 0.5, 0.8});
        assertThrows(NoSuchItemException.class, () -> vehiculeRentalSystem.rentItem(bike, today, tomorrow));
    }

    @org.junit.jupiter.api.Test
    void findAvailableMatches() throws NoSuchItemException {
        initRentalSystem();
