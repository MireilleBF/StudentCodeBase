...
class ElectricBikeTest extends fr.epu.vehicles.ElectricVehicleTest {
    ...
    void setUp() {
        ...
        bike = new ElectricBike(batteryCapacity, new double[]{energyConsumptionPerKilometer, 0.5, 0.8});
    ...
    void testIdentifiers() {
        ...
        ElectricBike bike2 = new ElectricBike(batteryCapacity, new double[]{energyConsumptionPerKilometer, 0.5, 0.8});
        assertEquals("EB-2", bike2.getName());
        ElectricBike bike3 = new ElectricBike(batteryCapacity, new double[]{energyConsumptionPerKilometer, 0.5, 0.8});
    ...
    @org.junit.jupiter.api.Test
    void getPedalAssistLevel() {
    }

    @org.junit.jupiter.api.Test
    void setPedalAssistLevel() {
    }
}